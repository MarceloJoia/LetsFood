...
@section('title', "Cargo disponível {$user->name}")

@section('content_header')

    <div class="row">
        <div class="col-sm-9 form-group">
            <h1>Cargo disponível <strong>{{ $user->name }}</strong></h1>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('users.roles', $user->id) }}" class="active">Cargos</a></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                   <form action="{{ route('users.roles.attach', $user->id) }}" method="POST" class="form-group">
